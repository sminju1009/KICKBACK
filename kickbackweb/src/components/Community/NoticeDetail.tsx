...
import { NavigationButtons, StyledNoticeHeader, NoticeDetailBox, NoticeContentBox, ButtonsContainer, BottomBox } from '../../styles/Notice/Notice'
    ...
    <>
      ...
      <NoticeDetailBox>
        ...
        <BottomBox>
          ...
          <div className='list' onClick={() => navigate("/notice")}>목록</div>
        </BottomBox>
      </NoticeDetailBox>
    </>
  );
