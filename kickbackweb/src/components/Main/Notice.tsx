    ...
    <div style={{ backgroundColor: "#f4f4f4"}}>
      <NoticeBox>
        <div className='item'>
          ...
          <div className='text'><span style={{ backgroundColor: "#239149" }}>업데이트</span>새로운 아이템 '화염병'이 추가되었습니다. 화염병은 적에게 화상 효과를 입히는 강력한 무기입니다.</div>
          <div className='text'><span style={{ backgroundColor: "#3a5ec0" }}>공지</span>게임 이용약관이 변경되었습니다. 변경 사항을 확인하고 동의해주세요.</div>
          <div className='text'><span style={{ backgroundColor: "#239149" }}>업데이트</span>매주 수요일에는 정기 업데이트가 진행됩니다. 게임의 새로운 내용을 기대해주세요!</div>
